...
def calculate_power(samples, board_voltage):
    ...
    ## Voltage samples for each channel
    ...
    for i in range(0, num_samples):
        ...
        """
        ## still in binary, sum of 1 and 0
        sum_raw_power_ct1 += ct1
        sum_raw_power_ct2 += ct2
        sum_raw_power_ct3 += ct3
        sum_raw_power_ct4 += ct4
        sum_raw_power_ct5 += ct5
        sum_raw_power_ct6 += ct6
        ...
        ## Power scaled from binary to real value
        inst_power_ct1 = ct1* 0.62*100
        inst_power_ct2 = ct2* 3.07*100
        inst_power_ct3 = ct3* 1.51*100
        inst_power_ct4 = ct4* 1*100
        inst_power_ct5 = ct5* 0.72*100
        inst_power_ct6 = ct6* 2.84*100
    ...
    """
    real_power_1 = inst_power_ct1
    real_power_2 = inst_power_ct2
    real_power_3 = inst_power_ct3
    real_power_4 = inst_power_ct4
    real_power_5 = inst_power_ct5
    real_power_6 = inst_power_ct6

    total_all= real_power_1 + real_power_2+ real_power_3 + real_power_4 + real_power_5 + real_power_6
    print('here is the total power' + str(total_all))
        ...
        try:
            ...
            if i < 2:
                ...
                if logger.handlers[0].level == 10:
                    t = PrettyTable(['', 'ct10', 'ct2', 'ct3', 'ct4', 'ct5', 'ct6'])
